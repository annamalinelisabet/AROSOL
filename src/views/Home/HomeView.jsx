    ...
    <div className='HomeView page-gap'>
      ...
      <div className='review-section container d-flex-column'>
        ...
        <swiper-container ref={swiperRef} init='false'>
          ...
          <swiper-slide><ReviewCard company='Privatperson' img={Review3} name='Anders Hellström' text='"Arosol fick uppdraget att installera solpaneler på mitt tak. Jag uppskattar den personliga kontakten, den tekniska expertis och erfarenhet de besitter och delar med sig av. Montage och installation skedde på planerat datum och slutresultatet är väldigt proffsigt. Jag har redan rekommenderat Arosol till min granne och nu är han lika nöjd med sin anläggning."' /></swiper-slide>
